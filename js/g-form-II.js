$(function() {
	$("#g-form-II").submit(function (event) {
		event.preventDefault();

		// Ссылка, которую получили на этапе публикации приложения
		let appLink = "https://script.google.com/macros/s/AKfycbyut9j-IHXUoUMHEAImN4Vv1vOLKImddd30Mhd92IyAMloEY0-XOmI8HmRKe2h79-xkKQ/exec";
		...
		let formTitle = $(this).find('#g-form-II-title_main');

		// h2 с ответом формы
		let formRespond = $(this).find('#g-form-II-title_respond');

		// Блок прелоадера
		let preloader = $(this).find('#g-form-II-preloader');

		// Кнопка отправки формы
		let submitButton = $(this).find('#g-form-II-button');
